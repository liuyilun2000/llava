...
from llava.mixtral_modification.configuration_mixtral import MixtralConfig
from llava.mixtral_modification.modeling_mixtral import MixtralModel, MixtralForCausalLM
...
class LlavaForConditionalGeneration(LlavaPreTrainedModel):
    def __init__(self, config: LlavaConfig):
        ...
        '''
        self.language_model = MixtralForCausalLM.from_config(
            config.text_config, attn_implementation=config._attn_implementation
        )
        '''
