...
from llava.qwen2_moe_modification.configuration_qwen2_moe import Qwen2MoeAdapterConfig
from llava.qwen2_moe_modification.modeling_qwen2_moe import Qwen2MoeAdapterModel, Qwen2MoeAdapterForCausalLM
...
AutoConfig.register("qwen2-moe-adapter", Qwen2MoeAdapterConfig)
AutoModel.register(Qwen2MoeAdapterConfig, Qwen2MoeAdapterModel)
AutoModelForCausalLM.register(Qwen2MoeAdapterConfig, Qwen2MoeAdapterForCausalLM)

'''
qwen2_moe_config = Qwen2MoeAdapterConfig(
    vocab_size=32002,
    shared_adapter=True,
...
qwen2_moe_model = Qwen2MoeAdapterForCausalLM.from_pretrained(
    '/home/atuin/b207dd/b207dd11/cache/huggingface/transformers/models--Qwen--Qwen1.5-MoE-A2.7B/snapshots/1a758c50ecb6350748b9ce0a99d2352fd9fc11c9',
    #mixtral_name, 
