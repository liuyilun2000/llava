...
deepspeed llava/train_parallel_deepspeed_mixtral_lora.py --num_stages=8 \
   --lora_r=128 --lora_alpha=256 --save_model_shard=26  --skip_shard=5040  \
...
deepspeed llava/train_parallel_deepspeed_mixtral_lora.py --num_stages=8 \
   --lora_r=32 --lora_alpha=64 --save_model_shard=2  --skip_shard=5180 \
...
cuda_mem_exceed_shard_skip_list = [
    76,   158,  182,  418,  421,  752,  814,  842,  991,  1266, 
    1366, 1425, 1464, 1574, 1728, 2166, 2441, 2563, 2739, 2854, 
...
#        shared_sparse_adapter_args={'r': 32, 'lora_alpha': 32, 'lora_dropout': 0.1},
    ...
    model = get_peft_model(model, config).model
