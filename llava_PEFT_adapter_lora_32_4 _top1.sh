...
deepspeed llava/train_parallel_deepspeed_mixtral_adapter_r.py --num_stages=8 \
   ...
   --shared_routing_adapter_type=LoRA --lora_r=32 --lora_alpha=64 \
   --save_model_shard=112  --skip_shard=4800  \
   --bf16=True  --lr=1e-5\
   --checkpoint_dir=/home/atuin/b207dd/b207dd11/LLaVA-PEFT_adapter_lora_32_64_4_top1_checkpoint \
   2>&1 | tee llava/train_parallel_deepspeed_mixtral_adapter_lora_32_64_4_top1.log
